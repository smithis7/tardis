...
Kevin (2/11/2020): The above has been done, and there is not a hyperlink for each code that has an arXiv code. Tried to begin opening a pdf but ran into encoding issues. Slight changes to the ads.ipynb and have the sample code to work with to see if we can decode a specific file for now.